      ...
      <View style={[styles.summaryCard, { backgroundColor: `${colors.primary}12`, borderColor: `${colors.primary}30` }]}>
        <View style={styles.summaryRow}>
          ...
          <View style={{ alignItems: 'flex-end' }}>
            <Text style={[styles.summaryLabel, { color: colors.danger, fontFamily: 'Inter_400Regular' }]}>Fatura total cartões</Text>
            <Text style={[styles.summarySubValue, { color: colors.danger, fontFamily: 'Inter_600SemiBold' }]}>{maskValue(formatBRL(totalCardUsed))}</Text>
          </View>
        </View>
      </View>
